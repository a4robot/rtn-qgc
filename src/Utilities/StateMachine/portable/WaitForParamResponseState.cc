...
WaitForParamResponseState::WaitForParamResponseState(QGCStateMachine *machine, int timeoutMsecs,
                                                     Predicate paramValuePredicate,
                                                     Predicate paramErrorPredicate)
    : WaitStateBase(QStringLiteral("WaitForParamResponseState"), machine, timeoutMsecs)
