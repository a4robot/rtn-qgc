...
// MapProvider::MapStyle mirrors QGeoMapType::MapStyle to keep this module
// free of <QtLocation/private/qgeomaptype_p.h> (so it can be used by
// Location-free consumers such as the terrain path). Drift between the two
// enums is caught by static_asserts at the QtLocation boundary in
