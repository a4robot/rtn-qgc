...
Item {
    ...
    PipState {
        ...
        onWindowAboutToOpen: {
            QGroundControl.videoManager2.stopVideo()
        ...
        onStateChanged: {
            if (pipState.state !== pipState.fullState) {
                QGroundControl.videoManager2.fullScreen = false
            }
        }
    }
    ...
    Timer {
        ...
        running:      false
        repeat:       false
        onTriggered:  QGroundControl.videoManager2.startVideo()
    }
    ...
    QGCLabel {
        ...
        visible: QGroundControl.videoManager2.fullScreen
    ...
    MouseArea {
        ...
        onDoubleClicked: QGroundControl.videoManager2.fullScreen = !QGroundControl.videoManager2.fullScreen
