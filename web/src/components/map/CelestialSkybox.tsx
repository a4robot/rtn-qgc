    ...
    if (constellationsRef.current) {
      ...
      for (const segment of (constellationsData as number[][][])) {
        for (let i = 0; i < segment.length - 1; i++) {
          ...
          const hor1 = convertEquatorialToHorizontal(now, { latitude: lat, longitude: lon }, { ra: pt1[0], dec: pt1[1] });
          ...
          const hor2 = convertEquatorialToHorizontal(now, { latitude: lat, longitude: lon }, { ra: pt2[0], dec: pt2[1] });
